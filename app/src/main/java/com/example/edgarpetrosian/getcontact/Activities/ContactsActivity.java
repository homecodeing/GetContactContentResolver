...
import com.example.edgarpetrosian.getcontact.Fragments.AllContactsFragment;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_allContacts:
                        ...
                        fragmentTransaction.replace(R.id.mainContainer, new AllContactsFragment());
